<div class="sidebar bg--dark">
    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <!-- <a class="sidebar__main-logo" href="{{ route('admin.dashboard') }}">LetzPoker</a> -->
            <h2 class="logo">LetzPoker</h2>
        </div>
            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a class="{{ menuActive('admin.gateway*', 3) }}" href="javascript:void(0)">
                        ...
                        <span class="menu-title">@lang('Manage Gateways')</span>
                    </a>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.pending') }}">
                                <a class="nav-link" href="{{ route('admin.deposit.pending') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Transactions')</span>
                            ...
                            <!-- <li class="sidebar-menu-item {{ menuActive('admin.deposit.approved') }}">
                                <a class="nav-link" href="{{ route('admin.deposit.approved') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Transactions')</span>
                                </a>
                            </li> -->
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.successful') }}">
                                <a class="nav-link" href="{{ route('admin.deposit.successful') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Successful Transactions')</span>
                                </a>
                            </li>
                            ...
                            <!-- <li class="sidebar-menu-item {{ menuActive('admin.deposit.rejected') }}">
                                <a class="nav-link" href="{{ route('admin.deposit.rejected') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Transactions')</span>
                                </a>
                            </li> -->
                            ...
                            <!-- <li class="sidebar-menu-item {{ menuActive('admin.deposit.initiated') }}">
                                ...
                                <a class="nav-link" href="{{ route('admin.deposit.initiated') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Initiated Transactions')</span>
                                </a>
                            </li> -->
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.list') }}">
                                <a class="nav-link" href="{{ route('admin.deposit.list') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Transactions')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
